...
func (r *RequestOptions) ToHeader() http.Header {
	...
	if r.ApiKey != "" {
		header.Set("Authorization", fmt.Sprintf("Bearer %v", r.ApiKey))
	}
	return header
}
...
func (r *RequestOptions) cloneHeader() http.Header {
	...
	headers.Set("X-Fern-SDK-Name", "github.com/Ryan-Amirthan/MovieAPI-GoSDK")
	headers.Set("X-Fern-SDK-Version", "v0.0.8")
	headers.Set("User-Agent", "github.com/Ryan-Amirthan/MovieAPI-GoSDK/1.0.1")
	return headers
}
